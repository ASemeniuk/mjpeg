...
public class DynamicGridView extends GridView {
    ...
    private boolean mUndoSupportEnabled = false;
    ...
    public void init(Context context) {
        ...
        mOverlapIfSwitchStraightLine = getResources().getDisplayMetrics().densityDpi * 16 / 160;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mHoverCell != null) {
                    if (mDropListener != null) {
                        ...
                        mDropListener.onActionDrop(mMobileItemPosition, position);
                    }
                }
                touchEventsEnded();
                break;
            ...
            case MotionEvent.ACTION_CANCEL:
                if (mHoverCell != null) {
                    if (mDropListener != null) {
                        mDropListener.onActionDrop(INVALID_POSITION, INVALID_POSITION);
                    }
                }
...
//            }
    ...
    private void reset(View mobileView) {
        ...
        mMobileItemPosition = INVALID_POSITION;
    ...
    public interface OnDropListener {
        void onActionDrop(int oldPosition, int newPosition);
    }
